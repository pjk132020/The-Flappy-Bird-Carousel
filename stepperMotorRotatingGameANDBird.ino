...
StepperControl motor2(motorInterfaceType, 22, 23, 24, 25, 3000, 500, 3000, 12000, 500);  // 500 ms flap duration

void setup() {
  // Initialize Motor 1 settings
  motor1.setMaxSpeed(1000); // Maximum steps per second
  motor1.setAcceleration(500); // Acceleration in steps per second^2
  int targetRPM1 = 3500;  // Set your target RPM for Motor 1
